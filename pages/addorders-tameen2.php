    ...
    <form id="orderstabledata" class="kt-form kt-form--fit kt-margin-b-20">
         ...
         <div class="col-lg-6">
           ...
           <div class="col-lg-6">
                ...
                <div class="form-group">
    				<label>ملاحظات</label>
    				<textarea type="text"  note="note" class="form-control" id="order_note" name="order_note" value="" style="margin-top: 0px; margin-bottom: 0px; height: 38px;"></textarea>
           ...
           <div class="form-group col-lg-2">
              <input type="button" tabindex="7" onclick="addOrders()" class="btn btn-primary" value="رفع و تاكيد الشحنه"  />
           </div>
          </div>
          <div class="row">
          <div class="col-md-12" >
