           ...
           <div class="col-lg-6">
                ...
                <div class="row">
        			...
        			<div class="form-group col-md-4">
        				...
        				<select  company="company" tabindex="4"  onchange='getApiStore($(this).val())' city="city" data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="company" id="company"  value="">
                    ...
                    <div class="form-group col-md-4">
        				...
        				<select   apistore="apistore" tabindex="5"  data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="apistore" id="apistore"  value="">
...
function addOrders(){
 $.ajax({
    url:"script/_addOrders-madar.php",
    type:"POST",
