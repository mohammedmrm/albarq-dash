...
<script type="text/javascript">
  ...
  function getall(p) {
    $.ajax({
      ...
      success: function(res) {
        ...
        $("#price-all").text(formatMoney(res.total[0].income));
  ...
  function getStoresOrdered(elem, client) {
    $.ajax({
      url: "script/_getStoresOrdered.php",
      type: "POST",
      data: {
        client: client
      },
