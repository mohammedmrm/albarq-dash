    ...
    <form id="orderstabledata" class="kt-form kt-form--fit kt-margin-b-20">
          ...
          <div class="form-group col-lg-2" style="display: none">
            ...
            <div class="form-group col-lg-2" style="display: ">
				<label>المدينه</label>
                <select  onchange="updatetown();driverOption()" onfocus="$(this).addClass('open')" data-show-subtext="true" data-live-search="true" type="text" class="  form-control dropdown-primary" name="maincity" id="maincity"  value="">
...
<!--			<div class="form-group col-lg-2">
			...
			<div class="form-group col-lg-2">
				...
				<select  city="city"  onchange='getTowns($("#town1"),$(this).val());thisDriver($("#driver1"),$(this).val())'  data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="city[]" id="city1"  value="">
                </select>
			...
			<div class="form-group col-lg-2">
				<label>المندوب</label>
				<select driver='driver'   data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="driver[]" id="driver1"  value="">
                </select>
                <span id="driver_err1" storeerr="storeerr" class="form-text text-danger"></span>
			</div>
            <div class="form-group  col-lg-2">
				<label>الوزن</label>
          ...
          <div class="row">
           ...
           <div  class="form-group col-lg-2">
			...
			<div class="form-group col-lg-2">
				...
				<select  city="city" onchange='`+`getTowns($("#town`+number+`"),$(this).val());thisDriver($("#driver`+number+`"),$(this).val())`+`' city="city" data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="city[]" id="city`+number+`"  value="">
                  `+cities+`
                </select>
			...
			<div class="form-group col-lg-2">
				<label>المندوب</label>
				<select driver='driver'   data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="driver[]" id="driver`+number+`"  value="">
                `+driver+`
                </select>
                <span id="driver_err`+number+`" storeerr="storeerr" class="form-text text-danger"></span>
			</div>
            <div class="form-group  col-lg-2">
				<label>الوزن</label>
...
function driverOption(){
  if($('#by').val() == 'city'){
    if($('#maincity').val() > 1){
      $("[driver='driver']").attr("disabled", true);
      $(".selectpicker").selectpicker("refresh");
    }else{
      $("[driver='driver']").attr("disabled", false);
      $(".selectpicker").selectpicker("refresh");
    }
    console.log($('#by').val(),$("[driver='driver']").html());
  }
}
function thisDriver(ele,city){
   if(city == 1){
...
function addOrders(){
 $.ajax({
    url:"script/_addOrders-hamsa.php",
    type:"POST",
    ...
    success:function(res){
       ...
       if(res.success == 1){
         ...
         $("#kt_form .text-danger").text("");
           ...
           $("#driver_err"+no).text(res.error["driver"]);
