    ...
    <form id="orderstabledata" class="kt-form kt-form--fit kt-margin-b-20">
         ...
         <div class="col-lg-6">
                <div class="form-group">
                	...
                	<input  no="no" tabindex="1"  id="order_no1" name="order_no" barcode="barcode"  type="text" class="form-control kt-input sp" placeholder="">
           ...
           <div class="col-lg-6">
			<div class="form-group"  >
				...
				<select store='store' tabindex="2" autofocus  data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="store" id="store"  value="">
...
<!--        			<div class="form-group col-md-4">
        				...
        				<select  company="company" tabindex="9"  onchange='getApiStore($(this).val())'  data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="company" id="company"  value="">

                        </select>
                        <span id="company_err"class="form-text text-danger"></span>
        			</div>
                    <div class="form-group col-md-4">
        				<label>احاله باسم السوق</label>
        				<select   apistore="apistore" tabindex="10"  data-show-subtext="true" data-live-search="true" type="text" class="selectpicker  form-control dropdown-primary" name="apistore" id="apistore"  value="">

                        </select>
                        <span id="store_err" class="form-text text-danger"></span>
        			</div>-->
    			</div>
           </div>
           </div>
...
function getApiStore(id){
      $.ajax({
        ...
        beforeSend:function(){
          $("#apistore").parent().addClass("loading");
        },
        success:function(res){
          $("#apistore").parent().removeClass("loading");
          $("#apistore").html("");
          console.log(res);
...
function addOrders(){
 $.ajax({
    url:"script/_addOrders-madar2.php",
    type:"POST",
